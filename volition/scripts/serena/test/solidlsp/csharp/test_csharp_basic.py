...
class TestCSharpSolutionProjectOpening:
    ...
    @pytest.mark.skip(reason="Test requires serena logging utilities")
    def test_csharp_language_server_logs_solution_discovery(self):
        """Test that CSharpLanguageServer logs solution/project discovery during initialization."""

    @pytest.mark.skip(reason="Test requires serena logging utilities")
    def test_csharp_language_server_logs_no_solution_warning(self):
