...
class Participant(BaseModel):
    ...
    cli: Literal[
        ...
        ...,
        description="HTTP adapter to use for this participant",
    )
    model: Optional[str] = Field(
        default=None,
        description=(
            "Model identifier (e.g., 'llama2', 'mistral', 'anthropic/claude-3.5-sonnet'). "
            "If omitted, the server will use the adapter's default model."
        ),
    )
