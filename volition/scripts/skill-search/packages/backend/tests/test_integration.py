...
from skill_search_backend.config import load_config
...
def test_list_skills_tool():
    ...
    from skill_search_backend.mcp_handlers import SkillsMCPServer, LoadingState
    from skill_search_backend.skill_loader import load_from_github
    import asyncio
...
def test_update_detection():
    ...
    """
    from skill_search_backend.update_checker import UpdateChecker
