...
class TestParticipantReasoningEffort:
    ...
    def test_reasoning_effort_accepts_valid_string(self):
        """Test reasoning_effort accepts string values (unused for HTTP adapters)."""
        p1 = Participant(cli="ollama", model="llama2", reasoning_effort="low")
        assert p1.reasoning_effort == "low"

        p2 = Participant(cli="openrouter", model="claude", reasoning_effort="medium")
    ...
    def test_reasoning_effort_serializes_correctly(self):
        ...
        p = Participant(cli="ollama", model="llama2", reasoning_effort="high")
        data = p.model_dump()
...
class TestDeliberateRequest:
    ...
    def test_valid_request_minimal(self):
        ...
        req = DeliberateRequest(
            ...
            participants=[
                ...
                Participant(cli="openrouter", model="anthropic/claude-3.5-sonnet"),
            ],
    ...
    def test_request_allows_missing_model(self):
        ...
        req = DeliberateRequest(
            ...
            participants=[
                Participant(cli="ollama"),
                Participant(cli="lmstudio"),
            ],
            working_directory="/tmp",
        )
    ...
    def test_requires_at_least_two_participants(self):
        ...
        with pytest.raises(ValidationError) as exc_info:
            DeliberateRequest(
                question="Test?",
                participants=[Participant(cli="ollama", model="llama2")],
                working_directory="/tmp",
            )
    ...
    def test_rounds_capped_at_five(self):
        ...
        with pytest.raises(ValidationError) as exc_info:
            DeliberateRequest(
                ...
                participants=[
                    Participant(cli="ollama", model="llama2"),
                    Participant(cli="openrouter", model="claude"),
                ],
                rounds=10,
                working_directory="/tmp",
            )
...
class TestRoundResponse:
    ...
    def test_valid_round_response(self):
        ...
        resp = RoundResponse(
            round=1,
            participant="llama2@ollama",
            response="I think we should consider...",
            timestamp="2025-10-12T15:30:00Z",
        )
        assert resp.round == 1
        assert "llama2" in resp.participant
...
class TestDeliberationResult:
    ...
    def test_valid_result(self):
        ...
        result = DeliberationResult(
            ...
            mode="conference",
            rounds_completed=2,
            participants=["llama2@ollama", "claude@openrouter"],
            summary={
...
class TestRoundVote:
    ...
    def test_valid_round_vote(self):
        ...
        assert round_vote.participant == "llama2@ollama"
