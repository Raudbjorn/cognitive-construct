...
echo "Publishing backend first (skill-search-backend)..."
...
echo "Publishing frontend (skill-search)..."
...
echo "  - skill-search-backend"
echo "  - skill-search"
echo ""
echo "Verify at:"
echo "  - https://pypi.org/project/skill-search-backend/"
echo "  - https://pypi.org/project/skill-search/"
echo ""
