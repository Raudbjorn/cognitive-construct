...
The skill-search-backend now includes automatic hourly skill updates synchronized to exact clockface hours (e.g., 12:00:00, 13:00:00).
...
- Stored in system temp directory: `/tmp/skill_search_cache/state/`
...
uvx skill-search-backend --config my-config.json
```
