/**
 * MCP-compliant error handling system for Anime Mori
...
export class AnimeMoriError extends Error {
...
export class ErrorFactory {
  static platformUnsupported(platform: string, arch: string): AnimeMoriError {
    return new AnimeMoriError(
  ...
  static nativeBindingFailed(originalError: Error, platform?: string): AnimeMoriError {
    return new AnimeMoriError(
  ...
  static fileNotFound(filePath: string, operation: string): AnimeMoriError {
    return new AnimeMoriError(
  ...
  static languageUnsupported(language: string, filePath?: string): AnimeMoriError {
    return new AnimeMoriError(
  ...
  static parseFailed(filePath: string, language: string, originalError?: Error): AnimeMoriError {
    return new AnimeMoriError(
  ...
  static databaseInitFailed(dbPath: string, originalError: Error): AnimeMoriError {
    return new AnimeMoriError(
      ...
      [
        ...
        { description: 'Run setup again', command: 'anime-mori setup --interactive' }
      ],
      originalError
    );
  }

  static invalidConfig(configPath: string, validationErrors: string[]): AnimeMoriError {
    return new AnimeMoriError(
      ...
      [
        ...
        { description: 'Run interactive setup', command: 'anime-mori setup --interactive' },
        { description: 'Reset to default configuration' }
      ]
    );
  }

  static circuitBreakerOpen(component: string, lastFailure?: Date): AnimeMoriError {
    return new AnimeMoriError(
...
export class ErrorUtils {
   ...
   */
  static isRecoverable(error: AnimeMoriError): boolean {
   ...
   */
  static logError(error: AnimeMoriError): void {
  ...
  /**
   * Convert standard Error to AnimeMoriError
   */
  static fromError(error: Error, context: ErrorContext = {}): AnimeMoriError {
    ...
    return new AnimeMoriError(
      ...
      [
        ...
        { description: 'Try running with debug mode', command: 'anime-mori debug --verbose' }
      ],
      error
    );
  }
