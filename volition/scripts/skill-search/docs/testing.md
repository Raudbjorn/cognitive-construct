...
```json
{
  "mcpServers": {
    "claude-skills-local": {
      ...
      "args": [
        "--directory",
        "/Users/yourusername/path/to/skill-search",
        "run",
        "skill-search",
        "--verbose"
      ]
...
```bash
npx @modelcontextprotocol/inspector uv --directory /path/to/skill-search run skill-search
```
...
View CI results at: [GitHub Actions](https://github.com/K-Dense-AI/skill-search/actions)
...
import pytest
from skill_search_backend.mymodule import my_function
