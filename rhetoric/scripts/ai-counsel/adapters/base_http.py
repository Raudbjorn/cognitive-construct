...
class BaseHTTPAdapter(ABC):
    ...
    async def invoke(
        ...
        Args:
            ...
            working_directory: Optional working directory (unused for HTTP, kept for
                             API compatibility with deliberation engine)
            reasoning_effort: Optional reasoning effort level (unused for HTTP, kept for
                            API compatibility)
